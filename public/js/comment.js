    ...
    Swal.fire({
      ...
      if (result.value) {
        $.ajax({
          ...
          success: function success(res) {
            if (res.status == 200) {
              $(".remove-comment-".concat(id)).parent().remove();
              Swal.fire({
                title: res.message,
                icon: "success",
                confirmButtonText: "Tiếp tục"
...
module.exports = __webpack_require__(/*! /home/user/Desktop/Dev/assignement_Laravel_php3/resources/js/comment.js */"./resources/js/comment.js");
