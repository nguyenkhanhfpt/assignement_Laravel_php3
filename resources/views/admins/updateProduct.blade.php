...
@section('content')
    <h2 class="text-center admin__title">Cập nhật sản phẩm</h2>
    ...
    <div class="box">
        <form action="" method="POST" enctype="multipart/form-data" class="mt-2">
            ...
            <div class="row">
                <div class="col">
                    <div class="form-group">
                        ...
                        placeholder="Nhập tên sản phẩm" value="{{$product->name_product}}" >
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="id_category" name="id_category">
                            <option selected value={{$product->id_category}}>{{$product->name}}</option>
                    ...
                    <div class="form-group">
                        ...
                        placeholder="Nhập giá của sản phẩm" value={{$product->price_product}} >
                        <small class="form-text text-danger">
                            @error('price_product')
                                {{ $message }}
                            @enderror
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        placeholder="Giảm giá cho sản phẩm" value={{$product->sale}} >
                    </div>
                    <div class="form-group">
                        ...
                        placeholder="Số lượng sản phẩm" value={{$product->quantity_product}} >
                        <small class="form-text text-danger">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="decscription" rows="5" name="decscription">{{ $product->decscription }}</textarea>
                <small class="form-text text-danger">
                    @error('decscription')
                        {{ $message }}
                    @enderror
            ...
            <div class="custom-control custom-checkbox mr-sm-2 mb-3">
                @if($product->nomination == 1)
                    <input type="checkbox" class="custom-control-input" name="nomination" checked id="nomination">
                @else
