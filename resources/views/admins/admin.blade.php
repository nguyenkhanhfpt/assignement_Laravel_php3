...
@section('content')
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Quan ly</h4>
        </div>
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                    <li class="breadcrumb-item active">Quan Ly</li>
                </ol>
            ...
            <div class="card">
                ...
                <div class="comment-widgets" id="comment" style="height: 629px;position: relative;">
                    ...
                    <div class="d-flex no-block comment-row">
                        <div class="p-2"><span class="round"><img src="http://eliteadmin.themedesigner.in/demos/bt4/assets/images/users/1.jpg" alt="user" width="50"></span></div>
                    ...
                    <div class="d-flex no-block comment-row border-top">
                        <div class="p-2"><span class="round"><img src="http://eliteadmin.themedesigner.in/demos/bt4/assets/images/users/2.jpg" alt="user" width="50"></span></div>
                    ...
                    <!-- Comment Row -->
                    <div class="d-flex no-block comment-row border-top">
                        <div class="p-2"><span class="round"><img src="http://eliteadmin.themedesigner.in/demos/bt4/assets/images/users/3.jpg" alt="user" width="50"></span></div>
                        <div class="comment-text w-100">
                    ...
                    <!-- Comment Row -->
                    <div class="d-flex no-block comment-row border-top">
                        <div class="p-2"><span class="round"><img src="http://eliteadmin.themedesigner.in/demos/bt4/assets/images/users/4.jpg" alt="user" width="50"></span></div>
                        <div class="comment-text active w-100">
                    ...
                    <div class="to-do-widget m-t-20" id="todo" style="height: 400px;position: relative;">
                        ...
                        <ul class="list-task todo-list list-group m-b-0" data-role="tasklist">
                            <li class="list-group-item" data-role="task">
                                ...
                                <ul class="assignedto">
                                    <li><img src="http://eliteadmin.themedesigner.in/demos/bt4/assets/images/users/1.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Steave"></li>
                                    <li><img src="http://eliteadmin.themedesigner.in/demos/bt4/assets/images/users/2.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Jessica"></li>
                                    <li><img src="http://eliteadmin.themedesigner.in/demos/bt4/assets/images/users/3.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Priyanka"></li>
                                    <li><img src="http://eliteadmin.themedesigner.in/demos/bt4/assets/images/users/4.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Selina"></li>
                                </ul>
                            </li>
                            <li class="list-group-item" data-role="task">
                                <div class="custom-control custom-checkbox">
                ...
                <div class="card-body">
                    ...
                    <div class="chat-box" id="chat" style="height: 327px;position: relative;">
                        ...
                        <ul class="chat-list">
                            <!--chat Row -->
                            <li>
                                <div class="chat-img"><img src="http://eliteadmin.themedesigner.in/demos/bt4/assets/images/users/1.jpg" alt="user"></div>
                            ...
                            <!--chat Row -->
                            <li>
                                <div class="chat-img"><img src="http://eliteadmin.themedesigner.in/demos/bt4/assets/images/users/2.jpg" alt="user"></div>
                                <div class="chat-content">
                                    <h5>Bianca Doe</h5>
                            ...
                            <!--chat Row -->
                            <li>
                                <div class="chat-img"><img src="http://eliteadmin.themedesigner.in/demos/bt4/assets/images/users/3.jpg" alt="user"></div>
                                <div class="chat-content">
